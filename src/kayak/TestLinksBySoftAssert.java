...
// this test is using softAssertion concept from testNG -> It test all links and then report the broken ones if there are any
package kayak;
...
public class TestLinksBySoftAssert {
	...
	public static void main(String[] args) throws MalformedURLException, IOException, URISyntaxException {
		...
		for (WebElement link : links) {
			...
			/*
			 * URI: Uniform Resource Identifier URI: is a class that has URL class in it
			 * that we need it. Why we need to access URL class -> to use the method of
			 * openConnection()
			 */
			...
			sa.assertTrue(responseCode < 400, "The link with text" + link.getText() + "is broken with status code of" + responseCode);
		}
	}
}
