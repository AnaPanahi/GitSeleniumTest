...
public class LimitScope {
	...
	public static void main(String[] args) {
		...
		/*
		 * 2.print quantity or count of links (a tage) in 'footer' only 
		 * First select footer section by limiting webDriver scope from entire webpage to footer
		 */
		...
		// 4.click on each link on the firts column of footer and check if pages are opened by opening the links in separate tabs
		for(int i = 0; i < columnDriver.findElements(By.tagName("a")).size(); i++){
			...
			// go to each tab and print the title
